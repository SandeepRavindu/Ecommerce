          ...
          <div className="min-w-0">
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 text-gray-600 group">
                ...
                <span className="transition-colors duration-300 group-hover:text-gray-800">+94-77-4877403</span>
              </li>
              <li className="flex items-center gap-3 text-gray-600 group">
                <div className="p-2 transition-all duration-300 border border-gray-300 rounded-lg shadow-sm bg-white/80 group-hover:border-gray-500">
                  <svg className="w-4 h-4 text-gray-500" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className="break-all transition-colors duration-300 group-hover:text-gray-800">sandeepravindu112@gmail.com</span>
              </li>
              <li className="flex items-center gap-3 text-gray-600 group">
                <div className="p-2 transition-all duration-300 border border-gray-300 rounded-lg shadow-sm bg-white/80 group-hover:border-gray-500">
                  <svg className="w-4 h-4 text-gray-500" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="px-6 pb-8 md:px-20 lg:px-32">
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
              <div className="text-sm text-gray-500">
                Copyright 2025@ ravindus.dev - All Right Reserved.
              </div>
